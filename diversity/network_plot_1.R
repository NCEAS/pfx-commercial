...
maxw = max(c(log(E(g2014)$weight), log(E(g1985)$weight)))
egam <- log(E(g2014)$weight) / maxw
E(g2014)$color <- rgb(0, 0, 1, alpha=egam)
E(g2014)$width <- egam
egam <- log(E(g1985)$weight) / maxw
E(g1985)$color <- rgb(0, 0, 1, alpha=egam)
E(g1985)$width <- egam
...
plot(g2014, layout=layout1,vertex.size=3, vertex.color = "dodgerblue", main="2014")
dev.off()
