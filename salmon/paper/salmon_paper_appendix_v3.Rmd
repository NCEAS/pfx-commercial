...
```{r figa1, fig.cap="Participation (unique people)", fig.pos="placeHere", echo=FALSE}
print(appendixPlot1)
```

\break  

```{r figa2, fig.cap="Diversity, mean revenue and CV (aggregated across years)", fig.pos="placeHere", echo=FALSE}
...
```{r figa5, fig.pos="placeHere", fig.cap="Time varying effects of adding 1 species on log standard deviation of revenue for hypothetical individuals with species diversity ~ 1.", echo=FALSE}
