...
author: "Eric, Sean, Ole, Rich, Milo, Jordan, Jen, Alan, others"
date: ''
output:
  pdf_document:
    fig_caption: yes
...
We obtained fisheries landings and revenue data for all permit holders in Alaska from 1985 - 2014 from the Commercial Fisheries Entry Commission (CFEC). We adjusted for inflation by setting all revenues in 2009 USD. Because we were only interested in single permit fisheries, we adopted a simplified version of the filtering steps described in [@anderson_benefits]. After aggregating individual trip-level fish tickets to annual data, we retained individuals who only fished one of the six salmon permits included in a year (Table 1, Fig. A5). Like [@anderson_benefits] we also worked with a log-differenced dataset to remove non-stationary individuals; to avoid complications of individuals switching strategies, we only included pairs of years for a given person where they did not change strategies. 
