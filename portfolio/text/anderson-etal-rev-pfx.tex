...
Gear types and permits are closely linked since in most cases a fisher would require a different permit to use different gear. The ability to diversify without changing gear or permits is therefore driven by biological availability and small-scale choices by fishers, such as fishing early versus late in a year or fishing in particular locations.
...
\url{https://github.com/NCEAS/pfx-commercial/tree/master/portfolio}. } \showmatmethods
