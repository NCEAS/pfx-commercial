...
% AOS tiny edits:
Individuals that rely on natural resources for their livelihoods,
such as fishers, farmers, and forestry workers,
face high levels of income variability.
For fishers, harvesting multiple species has been shown to
reduce revenue variability at large scales (vessels and communities)
but the individual-level consequences of maintaining catch diversity are unknown.
Our work demonstrates that individuals in fisheries targeting
a diversity of species
and individuals that participate in multiple fisheries
buffer income variability compared to less diverse individuals.
However, large adjustments in diversification strategies from year-to-year are risky and
usually increase revenue variability. The most effective option to
reduce revenue variability via diversification
--- purchasing additional permits ---
is also expensive, often limited by regulations,
and therefore unavailable to many.




Individuals relying on natural resources to sustain their livelihoods,
such as fishers, farmers, and forestry workers,
face high levels of income variability.
For fishers in particular, harvesting multiple species has been shown to
reduce revenue variability at large scales (vessels and communities)
but the individual-level consequences of maintaining catch diversity are unknown.
Our work demonstrates that individuals in fisheries targeting
a diversity of species
...
buffer income variability compared to less diverse individuals.
However, large adjustments in diversification strategies from year-to-year are risky and
usually increase revenue variability.
% \textbf{OR}
% However, specializing from year-to-year
% (reducing species diversity)
% tends to be associated with increased revenue
% as well as increased revenue variability
% when controlling for effort.
The most effective option for individuals to
reduce revenue variability via diversification
--- purchasing additional permits ---
is also expensive, often limited by regulations,
and therefore unavailable to many.
}
% We ask how multiple forms of
% species diversification affect individual-level
% revenue and revenue variability for Alaskan fishers.
...
usually (87\% probability) associated with increased revenue uncertainty
the following year. Our results demonstrate that the most effective option for
individuals to decrease revenue variability is to
