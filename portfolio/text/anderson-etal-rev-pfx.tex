...
\newlabel{fig:ifq}{7}
\newlabel{fig:mirror}{8}
\newlabel{fig:noeffort}{9}
...
% TODO: standardize and complete addresses
...
\noindent
$^4$Alaska Department of Fish and Game, Commercial Fisheries Division, Cordova, USA
...
\noindent
$^6$NOAA / National Marine Fisheries Service, Alaska Fisheries Science Center, Auke
