...
### Function definiton
We need to define a few functions for calculating diversity. We'll use the Simpson's diversity index (HHI) to calculate the entropy-based inverse, which is a proxy for effective species diversity.
...
# fixme I assume we no longer want to do this? -SA
...
cfecAnnual$salmon = ifelse(substr(cfecAnnual$permit,1,1)=="S", TRUE, FALSE)
...
nrow(cfecAnnual)
saveRDS(cfecAnnual, file="../data-generated/cfec-for-modeling.rds")
